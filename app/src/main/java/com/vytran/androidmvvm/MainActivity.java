package com.vytran.androidmvvm;
...
import com.vytran.androidmvvm.Adapters.RecyclerAdapter;
import com.vytran.androidmvvm.Models.NicePlace;
import com.vytran.androidmvvm.ViewModels.MainActivityViewModel;
...
public class MainActivity extends AppCompatActivity {
    ...
    private FloatingActionButton mFrab;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mFrab.setOnClickListener(new View.OnClickListener() {
            @Override
